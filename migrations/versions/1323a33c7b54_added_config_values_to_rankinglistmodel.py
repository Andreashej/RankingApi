"""added config values to RankingListModel

Revision ID: 1323a33c7b54
Revises: fd7a6eface74
Create Date: 2019-12-16 09:21:00.739133
...
revision = '1323a33c7b54'
down_revision = 'fd7a6eface74'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('rankinglists', sa.Column('included_marks', sa.Integer(), nullable=True))
    op.add_column('rankinglists', sa.Column('results_valid_days', sa.Integer(), nullable=True))
...
def downgrade():
    ...
    op.drop_constraint(None, 'results', type_='foreignkey')
    op.drop_constraint(None, 'results', type_='foreignkey')
    op.drop_column('rankinglists', 'results_valid_days')
