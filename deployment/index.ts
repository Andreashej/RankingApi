...
import {
  createWebserverContainer,
  createApplicationServerContainer,
...
const rqWorker = new awsx.ecs.FargateService("rq-worker", {
  ...
  desiredCount: 2,
  taskDefinitionArgs: {
    container: createApplicationServerContainer(appServerImage, redis, [
      "./rq-worker.sh",
    ]),
    executionRole: taskExecutionRole,
  },
